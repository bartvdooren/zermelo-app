...
jQuery.each( ("blur focus focusin focusout load resize scroll unload click dblclick " +
	"mousedown mouseup mousemove "+textTouchend+" mouseout mouseenter mouseleave " +
	...
	jQuery.cssHooks[ name ] = {
		get: function( elem, computed, extra ) {
			if ( computed ) {
				...
				if ( elem !== 0 ) {
					return getWidthOrHeight( elems_data, name, extra );
				} else {
					return jQuery.swap( elems_data, cssShow, function() {
						return getWidthOrHeight( elems_data, name, extra );
					});
				}
			}
